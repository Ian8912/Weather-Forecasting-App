...
export const RenderWeatherData = ({
  ...
  const [forecastError, setForecastError] = useState(null); // Track forecast fetch errors
  ...
  return (
    <div
      className="flex flex-col items-center justify-center w-full unified-weather-card rounded-3xl bg-blue-500"
      style={{
        borderRadius: '5rem',
        transform: 'scale(0.9)',
    ...
    >
      {loading ? (
        ...
        <div className="pb-6">
          ...
          {/* Display forecast error if any */}
          {forecastError ? (
            <p className="text-red-500 text-center">
              {translatedText.ForecastError || 'Error fetching forecast.'}
            </p>
          ) : (
            <ForecastDisplay
