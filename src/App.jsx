    ...
    <div className={darkMode ? 'dark' : ''}>
      <div className="p-12 bg-white dark:bg-[#0f172a]">
        ...
        <header className="bg-blue-500 text-white py-24 text-center dark:bg-[#1e1b4b] dark:text-[#cbd5e1]">
          ...
          <button className="mt-8 px-6 py-3 bg-blue-700 hover:bg-blue-800 rounded-lg dark:bg-[#312e81] dark:hover:bg-blue-700 transition duration-150 ease-in-out">Check Weather Now</button>
        </header>
